...
app.use(cors({origin:['https://clari-ecommerce-front.vercel.app/', 'https://api.mercadopago.com'], credentials:true, methods:'GET, POST, PUT, DELETE', allowedHeaders: ['Content-Type', 'Authorization']}));
